    ...
    public function index(Request $request)
    {
        ...
        return Inertia::render('Reportes/Ovinos', [
            ...
            'formulas' => [
                ...
                'fertilidad' => 'Partos ÷ servicios registrados × 100',
                'porcentaje_gestacion' => '(Diagnósticos positivos ÷ servicios registrados) × 100',
                'porcentaje_diagnosticos_positivos' => '(Diagnósticos positivos ÷ diagnósticos realizados) × 100',
                'porcentaje_servicios_con_parto' => '(Servicios que llegaron a parto ÷ servicios registrados) × 100',
                'porcentaje_supervivencia_crias' => '(Crías vivas ÷ crías con condición conocida) × 100',
                ...
                'porcentaje_mortalidad' => '(Fallecimientos ÷ rebaño histórico) × 100',
    'porcentaje_salidas' => '(Total de salidas del rebaño ÷ rebaño histórico) × 100',
            ],
        ]);
    }
}
