...
class BajaController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return Inertia::render('Bajas/Index', [
            ...
            // Venta, faena y sacrificio se registran desde sus propios
            // módulos (VentaController, FaenaController, SacrificioController)
            // y ya desactivan al animal por su cuenta — no se duplican aquí.
    ...
    {
        // Los 7 tipos que maneja Baja (fallecimiento, descarte
        // reproductivo, robo, extravío, donación, traslado, otra) son
        // igual de seguros de revertir: ninguno genera un registro
        // hermano en otra tabla (a diferencia de venta/faena/sacrificio),
        // así que no hay restricción de tipo aquí.
